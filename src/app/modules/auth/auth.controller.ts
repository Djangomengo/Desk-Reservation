...
export class AuthController {
    ...
    async changePassword(@CurrentUser() user: UserEntity, @Body() passwordChangeRequestDto: PasswordChangeRequestDto): Promise<AuthResponseDto> {
        await this.authService.changePassword(passwordChangeRequestDto, user.id)
